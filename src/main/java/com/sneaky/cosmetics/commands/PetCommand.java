...
public class PetCommand implements CommandExecutor, TabCompleter {
    ...
    private void handleFeedCommand(CommandSender sender, String[] args) {
        ...
        messageManager.sendSuccess(player, "§a✓ Fed your pet! Happiness increased!");
    ...
    private void showHelp(CommandSender sender) {
        ...
        messageManager.sendInfo(sender, "&#FF8C00║              &#FFD700Pet Management Commands             &#FF8C00║");
        messageManager.sendInfo(sender, "&#FF8C00╚════════════════════════════════════════════════════╝");
        messageManager.sendInfo(sender, "");
        ...
        messageManager.sendInfo(sender, "   &#FFA500• Leveling System &#808080- Pets gain XP and level up");
        messageManager.sendInfo(sender, "   &#FFA500• Happiness System &#808080- Happy pets gain more XP");
        messageManager.sendInfo(sender, "   &#FFA500• Feeding System &#808080- Feed pets to increase happiness");
        ...
        messageManager.sendInfo(sender, "   &#FFA500• Common &#808080- Easy to obtain");
        messageManager.sendInfo(sender, "   &#FFA500• Rare &#808080- Moderate difficulty");
        messageManager.sendInfo(sender, "   &#FFA500• Epic &#808080- Hard to obtain");
        messageManager.sendInfo(sender, "   &#FFA500• Legendary &#808080- Very rare pets");
        messageManager.sendInfo(sender, "");
